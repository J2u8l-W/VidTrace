...
if __name__ == '__main__':
    ...
    parser.add_argument("--load-batch", type=int, default=512, help="batch size of loading features to CPU")
    parser.add_argument("--inference-batch", type=int, default=256, help="batch size of TransVCL inference")
